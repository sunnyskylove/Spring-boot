...
//    @GetMapping("/lecture/conditional")
    ...
    public ModelAndView conditional(ModelAndView mv) {
        ...
        memberList.add(new MemberDTO("유관순",16,'여',"서울시 도봏구"));
    ...
    public ModelAndView etc(ModelAndView mv) {
        ...
        memberList.add(new MemberDTO("장보고",30,'남',"서울시 길도봉구"));
        ...
        memberMap.put("m02", new MemberDTO("유관순", 16, '여', "서울시노진구"));
        memberMap.put("m03", new MemberDTO("장보고", 30, '남', "서울시 길도봉구"));
